...
import { ChevronRight, ChevronLeft, Check, Sparkles, Building2, User, Phone, Mail, FileText, Target, Calendar, ArrowRight, ArrowLeft, RefreshCw, Save, Clock, Download, AlertCircle, Loader2 } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
        ...
        <div className="bg-[var(--surface-secondary)] p-4 rounded-2xl border border-[var(--border-default)] flex flex-col gap-2 min-w-[200px]">
          ...
          <div className="mt-2 text-xs text-[var(--text-muted)] flex flex-col gap-1">
            ...
            <div className="flex justify-between">
              <span>{isEn ? 'Dynamic Fields:' : 'الأقسام الفرعية:'}</span>
